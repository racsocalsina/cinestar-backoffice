...
@Component({
  selector: 'app-cm-corporate',
  templateUrl: './cm-corporate.component.html',
  styleUrls: ['./cm-corporate.component.scss']
})

export class CMCorporateComponent implements OnInit {  
  ...
  public getData() {    
    ...
    let cinestar = this.contentManagementService.getCorporate({'trade_name': Trades.CINESTAR});
    let movietime = this.contentManagementService.getCorporate({'trade_name': Trades.MOVIETIME});    
