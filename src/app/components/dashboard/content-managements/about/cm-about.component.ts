...
@Component({
  selector: 'app-cm-about',
  templateUrl: './cm-about.component.html',
  styleUrls: ['./cm-about.component.scss']
})

export class CMAboutComponent implements OnInit {  
  ...
  public getData() {    
    ...
    let cinestar = this.contentManagementService.getAbout({'trade_name': Trades.CINESTAR});
    let movietime = this.contentManagementService.getAbout({'trade_name': Trades.MOVIETIME});    
