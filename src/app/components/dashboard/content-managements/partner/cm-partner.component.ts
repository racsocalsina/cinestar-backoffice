...
@Component({
  selector: 'app-cm-partner',
  templateUrl: './cm-partner.component.html',
  styleUrls: ['./cm-partner.component.scss']
})

export class CMPartnerComponent implements OnInit {  
  ...
  public getData() {    
    ...
    let cinestar = this.contentManagementService.getPartner({'trade_name': Trades.CINESTAR});
    let movietime = this.contentManagementService.getPartner({'trade_name': Trades.MOVIETIME});    
